...
class BeautyDocumentsPage extends StatefulWidget {
  final String customerId; // Müşteri ID'si zorunlu
  final String? treatmentId;

  const BeautyDocumentsPage({
    super.key,
  ...
  @override
  State<BeautyDocumentsPage> createState() => _BeautyDocumentsPageState();
}

class _BeautyDocumentsPageState extends State<BeautyDocumentsPage> {
          ...
          DocumentUploadWidget(
            ...
            onDocumentUploaded: (document) {
              ...
              Provider.of<DocumentProvider>(context, listen: false)
                  .loadDocuments(panel: 'beauty', customerId: widget.customerId);
            },
            allowedTypes: [
              'kimlik',
              'sağlık_raporu',
