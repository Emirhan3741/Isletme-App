...
class CustomerModel {
  ...
  final String? eposta;
  final String? not;
  final DateTime oluşturulmaTarihi;
  ...
  factory CustomerModel.fromMap(Map<String, dynamic> map, String documentId) {
    return CustomerModel(
      ...
      eposta: map['eposta'],
      not: map['not'],
      oluşturulmaTarihi: (map['oluşturulmaTarihi'] as Timestamp?)?.toDate() ?? DateTime.now(),
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'eposta': eposta,
      'not': not,
      'oluşturulmaTarihi': Timestamp.fromDate(oluşturulmaTarihi),
